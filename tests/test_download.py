...
def test_download(tmpdir, data_type):
    ...
    if data_type == "kline_for_metatrader4":
        ...
        assert os.path.exists(os.path.join(tmpdir, BYBIT_DATA, "kline_for_metatrader4/ADAUSDT/2022/ADAUSDT_15_2022-09-01_2022-09-30.csv"))
        ...
        assert os.path.exists(
            os.path.join(tmpdir, BYBIT_DATA, "premium_index/ADAUSD/ADAUSD2022-03-24_premium_index.csv"))
        ...
        # If exists csv file on destination dir, test is passed.
        assert os.path.exists(
            os.path.join(tmpdir, BYBIT_DATA, "spot_index/ADAUSD/ADAUSD2022-03-24_index_price.csv"))

    elif data_type == "trading":
        single_download_url = "https://public.bybit.com/trading/10000LADYSUSDT/10000LADYSUSDT2023-05-11.csv.gz"
        downloader._download(single_download_url)
        # If exists csv file on destination dir, test is passed.
        print(os.path.join(tmpdir, BYBIT_DATA, "trading/10000LADYSUSDT/10000LADYSUSDT2023-05-11.csv"))
        assert os.path.exists(
            os.path.join(tmpdir, BYBIT_DATA, "trading/10000LADYSUSDT/10000LADYSUSDT2023-05-11.csv"))
